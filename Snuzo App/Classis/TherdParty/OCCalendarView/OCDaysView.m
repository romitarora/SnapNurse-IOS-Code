...
//    NSString * realTimeStr = [self getRealTimeFromUTCTimeDate:dateEightHoursAhead];
    ...
    NSDateComponents *today = [[NSCalendar currentCalendar] components:NSDayCalendarUnit | NSMonthCalendarUnit | NSYearCalendarUnit fromDate:finalDate];
		...
		for(int j = 0; j < 7; j++) {
			...
			if(dayNumber >= (weekdayOfFirst-1) && day <= numDaysInMonth) {
               ...
               // CGContextSetShadowWithColor(context, shadow2Offset, shadow2BlurRadius, shadow2);
                ...
                {
                    //[[UIColor colorWithRed: 180.0/255.0 green: 46.0/255.0 blue: 218.0/255.0 alpha: 1] setFill];
                    [globelColor setFill];
