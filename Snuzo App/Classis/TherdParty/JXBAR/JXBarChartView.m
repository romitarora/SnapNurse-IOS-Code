           ...
           gradient:(CGGradientRef)gradient
{
    ...
    if (self) {
        ...
        _textColor = textColor ? textColor :  globelColor;
        ...
        if (gradient) {
            ...
            CGFloat colorComponents[] = {0/255.0, 32/255.0,194.0/255.0, 1.0};
            size_t count = 1;
...
- (void)drawRect:(CGRect)rect
{
    ...
    for (int i = 0; i < count; i++) {
       ...
       // digitLabel.text = [self.values[i] stringValue]; hide label count
