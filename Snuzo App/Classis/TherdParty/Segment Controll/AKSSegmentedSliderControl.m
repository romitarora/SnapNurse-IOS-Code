...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _shadowBlur = 2.0;
        _strokeSize = 1.0;
        _strokeColor = [UIColor colorWithRed:96.0f/255.0f green:96.0f/255.0f blue:96.0f/255.0f alpha:1];//jam30
        ...
        NSArray *gradientColors = [NSArray arrayWithObjects:
                                   (id)[UIColor colorWithRed:96.0f/255.0f green:96.0f/255.0f blue:96.0f/255.0f alpha:1].CGColor,
        ...
        UIImage *imageToUse = [UIImage imageNamed:@"scroller-btn.png"];
        holderView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 28, 28)];
       
        [holderView setImage:imageToUse];
         holderView.layer.cornerRadius=14.0;
        ...
        [self addGestureRecognizer:[[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(handlePanGesture:)]];
...
- (void)drawRect:(CGRect)rect {
    ...
    [self fillRect:drawingRect withColor:[UIColor colorWithRed:96.0f/255.0f green:96.0f/255.0f blue:96.0f/255.0f alpha:1].CGColor onContext:_context];
