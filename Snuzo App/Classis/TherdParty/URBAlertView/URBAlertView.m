...
//            self.transform = translate;
	...
	// default "pop" animation like UIAlertView
		...
		if (show) {
			...
			[self showOverlay:NO];
			// raju 0.18 to 0.0 duration
			[UIView animateWithDuration:0.0 animations:^{
				self.transform = CGAffineTransformScale(transform, 1.1, 1.1);
			} completion:^(BOOL finished) {
                [UIView animateWithDuration:0.0 animations:^{		// raju 0.18 to 0.0 duration
...
//    [self.contentView addSubview:beloved]; //temp 16-4 //viral
    ...
    UIImageView *beloved = [[UIImageView alloc] init];//beloved-log17N.png
    beloved.frame=CGRectMake(layoutFrame.size.width/2-34.75,-19.5 , 62.5,39); //75, -25, 130, 60
    [beloved setImage:[UIImage imageNamed:@"alert_popup"]];
    //    beloved.frame = CGRectMake(self.contentView.frame.size.height/2, 0, 130, 60);
    beloved.layer.borderColor = [UIColor whiteColor].CGColor;
...
//    UIColor *buttonInnerGradientColor2 = [UIColor lightGrayColor];//viral
    ...
    UIColor *buttonInnerGradientColor = [USColor colorFromHexString:@"#d3d3d3"];//light gray color
    UIColor *buttonInnerGradientColor2 = [USColor colorFromHexString:@"#d3d3d3"];//viral
