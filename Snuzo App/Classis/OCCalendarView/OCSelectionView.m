...
- (void)drawRect:(CGRect)rect
{
    if(selected) {
        ...
        UIColor* color = [UIColor colorWithRed: 180.0/255.0 green: 46.0/255.0 blue: 218.0/255.0 alpha: 0.86];
        
        UIColor* color2 = [UIColor colorWithRed: 180.0/255.0 green: 46.0/255.0 blue: 218.0/255.0 alpha: 0.88];
